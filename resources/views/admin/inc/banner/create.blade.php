...
@section('content')
    <div id="content">
        <div id="content-header">
            ...
            Home</a><a href="{{ route('Banner.create')}}" class="current">Create Banner</a> </div>
            <h1>Form create</h1>
        </div>
                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form class="form-horizontal" enctype="multipart/form-data" method="post" action="{{ route('Banner.create')}}" name="add_Banner" id="add_Banner" novalidate="novalidate"> {{ csrf_field()}}
